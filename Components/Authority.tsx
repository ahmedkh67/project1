...
function Authority ({Title, src, Dis }: AuthorityParams) {
  return (
    <>
      ...
      transition={{duration: 1.1, ease: easeInOut}} className="flex w-full justify-center items-center p-4 ">
      ...
      <div className="w-full md:px-[21%] flex-col " >
        ...
        <Image src={src} width={800} height={800} alt="im" className="rounded-3xl md:mx-0 mb-3" />
          ...
          <motion.div  initial={{translateY: 30}} animate={{translateY: 0}} 
          transition={{duration: 1.7, ease: easeOut, delay: 1.2}}
       className="flex md:w-40 md:h-40 w-30 h-30 border-1 border-[#17171] border-solid rounded-full 
       justify-center items-center md:mb-15 my-8">
        <p className="text-2xl font-light font-sans text-start" >
          Contact
        </p>
